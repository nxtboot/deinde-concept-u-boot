...
/*
 * GUIDs which U-Boot does not implement, but which show up in a log of the
 * calls an application makes. They are here so that a trace names them rather
 * than showing a bare number; see list_guid[] in lib/uuid.c
 */

/* protocols which applications probe for */
#define EFI_CONSOLE_CONTROL_PROTOCOL_GUID \
	EFI_GUID(0xf42f7782, 0x012e, 0x4c12, \
		 0x99, 0x56, 0x49, 0xf9, 0x43, 0x04, 0xf7, 0x21)

#define EFI_CC_MEASUREMENT_PROTOCOL_GUID \
	EFI_GUID(0x96751a3d, 0x72f4, 0x41a6, \
...
#define LINUX_EFI_LOADED_IMAGE_FIXED_GUID \
	EFI_GUID(0xf5a37b6d, 0x3344, 0x42a5, \
		 0xb6, 0xbb, 0x97, 0x86, 0x48, 0xc1, 0x89, 0x0a)

/* configuration tables which the Linux EFI stub installs */
#define LINUX_EFI_RANDOM_SEED_TABLE_GUID \
	EFI_GUID(0x1ce1e5bc, 0x7ceb, 0x42f2, \
		 0x81, 0xe5, 0x8a, 0xad, 0xf1, 0x80, 0xf5, 0x7b)

#define LINUX_EFI_MEMRESERVE_TABLE_GUID \
	EFI_GUID(0x888eb0c6, 0x8ede, 0x4ff5, \
		 0xa8, 0xf0, 0x9a, 0xee, 0x5c, 0xb9, 0x77, 0xc2)

#define LINUX_EFI_BOOT_MEMMAP_GUID \
	EFI_GUID(0x800f683f, 0xd08b, 0x423a, \
