 ...
 *
 * Alder Lake GPIO definitions, for the PCH-P / PCH-M variants. The pad
 * numbers are those used by the Alder Lake pinctrl driver, running from
 * GPP_B0 upwards through the GPIO communities.
 *
 * Based on the coreboot Alder Lake support, which in turn comes from the
 * Alder Lake PCH datasheet (document 630094 chapter 27 and 630603
 * chapter 16)
 */
...
/* Each pad has four configuration registers: DW0 to DW3 */
#define GPIO_NUM_PAD_CFG_REGS	4

/* Register offsets within a GPIO community */
...
/* Sideband port IDs of the GPIO communities */
