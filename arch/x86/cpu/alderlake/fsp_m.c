...
int fspm_update_config(struct udevice *dev, struct fspm_upd *upd)
{
	...
	/*
	 * The memory settings themselves come from the FSP's own defaults,
	 * which the caller has already copied in. Only the architectural
	 * settings, which tell the FSP where it may put its stack, are
	 * provided here.
	 */
